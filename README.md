...
- Univariate Analysis (Histogram) of Numerical Feature ![Alt Text](outputs/Univariate Analysis of Numerical Features.jpg)
- Univariate Analysis (Bar) of Categorical Feature ![Alt Text](outputs/Univariate Analysis of Categorical Features.jpg)
- Multivariate Analysis (Correlation of Numerical Features) ![Alt Text](outputs/Multivariate Analysis (Correlation of Numerical Features).jpg)
